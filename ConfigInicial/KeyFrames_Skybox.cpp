// Skybox                              Cristina Silva Alarcón
// Fecha de Entrega: 05/05/26          319271108
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Animacion maquina de estados - Cristina Silva Alarcon", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Skybox cube
		glBindVertexArray(skyboxVAO);
		glActiveTexture(GL_TEXTURE1);  // ✅ Cambiado de GL_TEXTURE0 a GL_TEXTURE1
